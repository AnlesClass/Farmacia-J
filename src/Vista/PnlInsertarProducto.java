...
public class PnlInsertarProducto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        comboxCategoría.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Sin Categoría>", " " }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String sql = "SELECT TP.IdTipoProducto FROM TipoProducto TP WHERE Nombre = ?;";
        ...
        try {
            ...
            var vector = new String[6];
            if (rs.next()) {
                //Carga a Producto
                prod.setIdProducto(rs.getInt(1));
                prod.setNombre(vector[1]);
                prod.setDescripcion(vector[2]);
                prod.setVentaConReceta(chboxVentaConReceta.isSelected());
                prod.setPrecio((float) snrPrecio.getValue());
                prod.setActivo(true);
                //Carga a Tabla
                vector[0] = rs.getString(1);
                vector[1] = tfdNombre.getText();
                vector[2] = tfdDescripcion.getText();
                vector[3] = String.valueOf(chboxVentaConReceta.isSelected());
                vector[4] = String.valueOf(snrPrecio.getValue());
                vector[5] = String.valueOf(true);
                dtm.addRow(vector);
            }
